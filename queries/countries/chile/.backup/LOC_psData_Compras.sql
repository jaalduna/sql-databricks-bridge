...
-- source table: [cl_ps].dbo.loc_psdata_compras
-- target table: 003-precios.bronze-data.fact_loc_ps_compras
-- parameters: [cl_ps], , 2024-01-01, 2024-12-31
-- note: cross-database query — requires access to [cl_ps]
...
select
    ...
    ps.flg_duplicado,
    ps.idcountry
from [cl_ps].dbo.loc_psdata_compras ps
