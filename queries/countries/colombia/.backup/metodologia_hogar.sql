-- source: colombia/queries.py - get_metodologia_hogar()
-- description: gets the household methodology data matching power bi's structure and processing
-- tables: j_atoscompra_new, hato_cabecalho
