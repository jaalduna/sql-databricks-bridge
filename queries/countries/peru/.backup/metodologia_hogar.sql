-- source: peru/queries.py::get_metodologia_hogar
-- description: gets the household methodology data matching power bi's exact logic
-- note: includes pnc and tivian ctes for household methodology classification
    ...
    with pnc as (
        ...
        from j_atoscompra_new with (nolock)
        left join hato_cabecalho with (nolock)
